...
function add_scripts_files()
{
    ...
    wp_enqueue_script('my-common-script', get_template_directory_uri() . '/contexts/global/js/common.js', array(), filemtime(get_theme_file_path('/contexts/global/js/common.js')), true, true);
}
